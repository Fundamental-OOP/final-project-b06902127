...
public class FourSelfTriplets extends ScoringPattern {
	public FourSelfTriplets() {
		super("FourSelfTriplets", 2, Arrays.asList("ThreeSelfTriplets"));
	}
