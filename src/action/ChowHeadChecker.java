...
public class ChowHeadChecker extends ActionChecker {
    public ChowHeadChecker() {
        super(new ChowHoleChecker());
    }
    ...
    public List<Action> check(Player player, Tile tile) {
        ...
        Tile t11 = new SuitedTile(suitedTile.getSuitedType(), suitedTile.getRank()+1);
        Tile t12 = new SuitedTile(suitedTile.getSuitedType(), suitedTile.getRank()+2);
